...
//		mCamera.update();
	...
	//    
	   ...
	   // arrow15.setPosition(1050, 220);
	    ...
	    arrow1.addAction(Actions.forever(Actions.sequence(Actions.rotateBy(movement,timing),Actions.rotateBy(-movement,timing))));
	    arrow2.setOrigin(arrow1.getWidth()/2, arrow1.getHeight()/2);
	    arrow2.addAction(Actions.forever(Actions.sequence(Actions.rotateBy(movement,timing),Actions.rotateBy(-movement,timing))));
	    arrow3.setOrigin(arrow1.getWidth()/2, arrow1.getHeight()/2);
	    arrow3.addAction(Actions.forever(Actions.sequence(Actions.rotateBy(movement,timing),Actions.rotateBy(-movement,timing))));
	    arrow4.setOrigin(arrow1.getWidth()/2, arrow1.getHeight()/2);
	    arrow4.addAction(Actions.forever(Actions.sequence(Actions.rotateBy(movement,timing),Actions.rotateBy(-movement,timing))));
	    arrow5.setOrigin(arrow1.getWidth()/2, arrow1.getHeight()/2);
	    arrow5.addAction(Actions.forever(Actions.sequence(Actions.rotateBy(movement,timing),Actions.rotateBy(-movement,timing))));
	    arrow6.setOrigin(arrow1.getWidth()/2, arrow1.getHeight()/2);
	    arrow6.addAction(Actions.forever(Actions.sequence(Actions.rotateBy(movement,timing),Actions.rotateBy(-movement,timing))));
	    arrow7.setOrigin(arrow1.getWidth()/2, arrow1.getHeight()/2);
	    arrow7.addAction(Actions.forever(Actions.sequence(Actions.rotateBy(movement,timing),Actions.rotateBy(-movement,timing))));
	    arrow8.setOrigin(arrow1.getWidth()/2, arrow1.getHeight()/2);
	    arrow8.addAction(Actions.forever(Actions.sequence(Actions.rotateBy(movement,timing),Actions.rotateBy(-movement,timing))));
	    arrow9.setOrigin(arrow1.getWidth()/2, arrow1.getHeight()/2);
	    arrow9.addAction(Actions.forever(Actions.sequence(Actions.rotateBy(movement,timing),Actions.rotateBy(-movement,timing))));
	    arrow10.setOrigin(arrow1.getWidth()/2, arrow1.getHeight()/2);
	    arrow10.addAction(Actions.forever(Actions.sequence(Actions.rotateBy(movement,timing),Actions.rotateBy(-movement,timing))));
	    arrow11.setOrigin(arrow1.getWidth()/2, arrow1.getHeight()/2);
	    arrow11.addAction(Actions.forever(Actions.sequence(Actions.rotateBy(movement,timing),Actions.rotateBy(-movement,timing))));
	    arrow12.setOrigin(arrow1.getWidth()/2, arrow1.getHeight()/2);
	    arrow12.addAction(Actions.forever(Actions.sequence(Actions.rotateBy(movement,timing),Actions.rotateBy(-movement,timing))));
	    arrow13.setOrigin(arrow1.getWidth()/2, arrow1.getHeight()/2);
	    arrow13.addAction(Actions.forever(Actions.sequence(Actions.rotateBy(movement,timing),Actions.rotateBy(-movement,timing))));
	    arrow14.setOrigin(arrow1.getWidth()/2, arrow1.getHeight()/2);
	    arrow14.addAction(Actions.forever(Actions.sequence(Actions.rotateBy(movement,timing),Actions.rotateBy(-movement,timing))));
	    arrow16.setOrigin(arrow1.getWidth()/2, arrow1.getHeight()/2);
	    arrow16.addAction(Actions.forever(Actions.sequence(Actions.rotateBy(movement,timing),Actions.rotateBy(-movement,timing))));
	    arrow17.setOrigin(arrow1.getWidth()/2, arrow1.getHeight()/2);
	    arrow17.addAction(Actions.forever(Actions.sequence(Actions.rotateBy(movement,timing),Actions.rotateBy(-movement,timing))));
	    arrow18.setOrigin(arrow1.getWidth()/2, arrow1.getHeight()/2);
	    arrow18.addAction(Actions.forever(Actions.sequence(Actions.rotateBy(movement,timing),Actions.rotateBy(-movement,timing))));
	    arrow19.setOrigin(arrow1.getWidth()/2, arrow1.getHeight()/2);
	    arrow19.addAction(Actions.forever(Actions.sequence(Actions.rotateBy(movement,timing),Actions.rotateBy(-movement,timing))));
	    arrow20.setOrigin(arrow1.getWidth()/2, arrow1.getHeight()/2);
	    arrow20.addAction(Actions.forever(Actions.sequence(Actions.rotateBy(movement,timing),Actions.rotateBy(-movement,timing))));
	    arrow21.setOrigin(arrow1.getWidth()/2, arrow1.getHeight()/2);
	    arrow21.addAction(Actions.forever(Actions.sequence(Actions.rotateBy(movement,timing),Actions.rotateBy(-movement,timing))));
	    arrow22.setOrigin(arrow1.getWidth()/2, arrow1.getHeight()/2);
	    arrow22.addAction(Actions.forever(Actions.sequence(Actions.rotateBy(movement,timing),Actions.rotateBy(-movement,timing))));
	    arrow23.setOrigin(arrow1.getWidth()/2, arrow1.getHeight()/2);
	    arrow23.addAction(Actions.forever(Actions.sequence(Actions.rotateBy(movement,timing),Actions.rotateBy(-movement,timing))));
	    arrow24.setOrigin(arrow1.getWidth()/2, arrow1.getHeight()/2);
	    arrow24.addAction(Actions.forever(Actions.sequence(Actions.rotateBy(movement,timing),Actions.rotateBy(-movement,timing))));
	    arrow25.setOrigin(arrow1.getWidth()/2, arrow1.getHeight()/2);
	    arrow25.addAction(Actions.forever(Actions.sequence(Actions.rotateBy(movement,timing),Actions.rotateBy(-movement,timing))));
	    arrow26.setOrigin(arrow1.getWidth()/2, arrow1.getHeight()/2);
	    arrow26.addAction(Actions.forever(Actions.sequence(Actions.rotateBy(movement,timing),Actions.rotateBy(-movement,timing))));
